    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      <section id='contact' className={`${darkMode ? 'dark bg-gray-800' : 'light bg-red-100'}lg:w-[95%] w-full h-fit m-auto  rounded-xl grid lg:grid-cols-2 grid-cols-1 justify-center items-center lg:px-36 px-6 py-20 gap-10`}>
        ...
        <div className='flex flex-col justify-center items-start gap-8 lg:p-20 p-6'>
          ...
          <h1 data-aos="zoom-in" data-aos-delay="400" className='text-black text-[20px] font-semibold leading-10 dark:text-white'>We are here to help! If you have any questions about our listings, services, or anything else, please feel free to reach out to us.</h1>
